...
public class ICCWomenTest {

	@Test
	public void playerRankingWomenTest() throws InterruptedException {
		...
		driver.findElement(By.xpath("//a[contains(text(),'Player Rankings')]")).click();
