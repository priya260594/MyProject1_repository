...
String CONTNAME=cell.getStringCellValue();
...
driver.findElement(By.xpath("//img[@alt='Create Contact...']")).click();
		...
		// 5. create contact with mandatory fields
driver.findElement(By.xpath("//input[@name='firstname']")).sendKeys(args);
driver.findElement(By.xpath("//input[@name='lastname']")).sendKeys(CONTNAME+RANDOM);
